(function () {
  ...
  /* Soft image fade-in as assets load */
  (function enhanceImageLoads() {
    const images = document.querySelectorAll(
      ".product-card__image img, .four-square-grid__bottomleft img, .shop-product__media img, .schedule-gallery__item img, .product-detail__media img, .pods-block img, .about-service-area img"
    );
  ...
  /* Soft scroll reveals for products + story grid */
  (function enhanceSectionReveals() {
    const targets = document.querySelectorAll(
      ".products-section, .four-square-grid-section"
    );

    targets.forEach(function (section) {
      const items = section.querySelectorAll(
        ".products-section__intro, .product-card, .four-square-grid__topleft, .four-square-grid__topright, .four-square-grid__bottomleft, .four-square-grid__bottomright"
      );
